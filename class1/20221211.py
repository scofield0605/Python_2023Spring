...
titleImage=Image.open('/Users/scofield/Documents/Python_2022Autumn/Python_2022Autumn/class10.py/image/logo_tree.png')
...
bannerImage=Image.open('/Users/scofield/Documents/Python_2022Autumn/Python_2022Autumn/class10.py/image/Orange Modern Special Offer Big Sale Facebook Ad.png')
...
sofa1Image=Image.open('/Users/scofield/Documents/Python_2022Autumn/Python_2022Autumn/class10.py/image/Screenshot 2022-12-17 at 13.04.27.png')
...
sofa2Image=Image.open('/Users/scofield/Documents/Python_2022Autumn/Python_2022Autumn/class10.py/image/Screenshot 2022-12-17 at 12.54.20.png')
...
sofa3Image=Image.open('/Users/scofield/Documents/Python_2022Autumn/Python_2022Autumn/class10.py/image/Screenshot 2022-12-17 at 13.08.00.png')
...
sofa4Image=Image.open('/Users/scofield/Documents/Python_2022Autumn/Python_2022Autumn/class10.py/image/Screenshot 2022-12-17 at 13.13.35.png')
...
def createNewWindow():
    ...
    sofa1=Button(new, text='主機',width=5,pady=2, font=('Inter',18))
    bed1=Button(new, text='筆電',width=5,pady=2,font=('Inter',18))
    kit1=Button(new, text='顯卡',width=5,pady=2,font=('Inter',18))
    member1=Button(new,text='會員登入',width=12,pady=2,font=('Inter',18))
    sofa1.grid(row=0,column=1,sticky=W)
    ...
    sofa1label1.grid(row=2,column=0,columnspan=2,sticky=W, padx=5)

    sofa2Image1=Image.open('/Users/scofield/Documents/Python_2022Autumn/Python_2022Autumn/class10.py/image/Screenshot 2022-12-17 at 14.34.25.png')
    ...
    sofa3label1.grid(row=2,column=4,columnspan=2,sticky=W, padx=5)

    sofa4Image1=Image.open('/Users/scofield/Documents/Python_2022Autumn/Python_2022Autumn/class10.py/image/mbp16-spacegray-select-202110_GEO_TW.jpeg')
    ...
    minusbutton11.grid(row=4,column=1,sticky=W)
...
def thenew():
    ...
    bannerImage2=Image.open('/Users/scofield/Documents/Python_2022Autumn/Python_2022Autumn/class10.py/image/Orange Modern Special Offer Big Sale Facebook Ad.png')
    ...
    sofa1Image2=Image.open('/Users/scofield/Documents/Python_2022Autumn/Python_2022Autumn/class10.py/image/Screenshot 2022-12-17 at 15.10.05.png')
    ...
    sofa2Image2=Image.open('/Users/scofield/Documents/Python_2022Autumn/Python_2022Autumn/class10.py/image/Screenshot 2022-12-17 at 15.11.00.png')
    ...
    sofa3Image2=Image.open('/Users/scofield/Documents/Python_2022Autumn/Python_2022Autumn/class10.py/image/Screenshot 2022-12-17 at 15.11.38.png')
    ...
    sofa4Image2=Image.open('/Users/scofield/Documents/Python_2022Autumn/Python_2022Autumn/class10.py/image/Screenshot 2022-12-17 at 15.12.49.png')
    ...
    chartImage1=Image.open('/Users/scofield/Documents/Python_2022Autumn/Python_2022Autumn/class10.py/image/Shopping Cart.png')
...
addbutton4=Button(root,text='+',font=('Inter',10),command=lambda: add(number4,productprice4))
